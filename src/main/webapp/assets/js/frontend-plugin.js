jQuery(document).ready(function ($) {
    "use strict";
   function fm0154_init_menu_toggle() {
        var contain = '.nav-toggle';
    ...
    // ----------fm0154_custom_scrollbar-------------------
    function fm0154_custom_scrollbar() {
        $('.mini-cart .minicart-items').mCustomScrollbar();
        $('.mini-cart .minicart-items').change(function () {
            $('.mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function fm0154_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function fm0154_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function fm0154_remove_class_review() {
    ...
    // -----------fm0154_details_thumd--------------------
    function fm0154_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* TOGGLE */
    function fm0154_dropdown() {
        $(document).on('click', '.header-control .close', function () {
            $(this).closest('.dropdown').removeClass('open');
        });
        $(document).on('click', function (event) {
            var _target = $(event.target).closest('.dropdown');
            var _allparent = $('.dropdown');

            if (_target.length > 0) {
                _allparent.not(_target).removeClass('open');
                if (
                    $(event.target).is('[data-fm0154="dropdown"]') ||
                    $(event.target).closest('[data-fm0154="dropdown"]').length > 0
                ) {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function fm0154_tab_fade_effect() {
        // effect click
        $(document).on('click', '.tabs .tab-link a', function () {
    ...
    function quickview_popup() {
        ...
        if (window_size > 992) {
            $(document).on('click', '.quick-wiew-button', function () {
                $.magnificPopup.open({
                    items: {
                        src: '<div class="kt-popup-quickview "><div class="details-thumb"><div class="slider-product slider-for"><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div></div><div class="slider-product-button slider-nav nav-center"><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div></div></div><div class="details-infor"><h1 class="product-title">夫妻筷/夫婦箸</h1><div class="stars-rating"><div class="star-rating"><span class="star-5"></span></div><div class="count-star">(7)</div></div><div class="availability">商品狀態:<a href="#">全新品</a></div><div class="price"><span>$990</span></div><div class="product-details-description"><ul><li>在日本筷子的發音，音似「橋樑」；故也有「幸福之橋」的含意。</li><li>機器製造</li><li>不銹鋼</li></ul></div><div class="variations"><div class="attribute attribute_color"><div class="color-text text-attribute">顏色:<span>黑/</span><span>灰/</span><span>紅棕</span></div><div class="list-color list-item"><a href="#" class="color1"></a><a href="#" class="color2"></a><a href="#" class="color3 active"></a><a href="#" class="color4"></a></div></div></div><div class="group-button"><div class="yith-wcwl-add-to-wishlist"><div class="yith-wcwl-add-button"><a href="#">收藏</a></div></div><div class="quantity-add-to-cart"><div class="quantity"><div class="control"><a class="btn-number qtyminus quantity-minus" href="#">-</a><input type="text" data-step="1" data-min="0" value="1" title="Qty" class="input-qty qty" size="4"><a href="#" class="btn-number qtyplus quantity-plus">+</a></div></div><button class="single_add_to_cart_button button">加入購物車</button></div></div></div></div>',
                        type: 'inline'
                    }
                });
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    $(window).resize(function () {
        ...
        fm0154_masonry()
        kt_resizeMegamenu();
        fm0154_remove_class_review();
        fm0154_details_thumd_zoom();
        fm0154_custom_scrollbar();
    });
    $(window).load(function () {
        newletter_popup();
    ...
    fm0154_masonry()
    fm0154_dropdown();
    fm0154_init_carousel();
    fm0154_remove_class_review();
    fm0154_tab_fade_effect();
    fm0154_details_thumd_zoom();
    fm0154_video();
    kt_resizeMegamenu();
    fm0154_custom_scrollbar();
    fm0154_countdown();
    fm0154_init_menu_toggle();
    fm0154_custom_scrollbar_header_nav();
}); 