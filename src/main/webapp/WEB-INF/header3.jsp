			...
			<div class="main-header">
				<div class="row">
					<div
						...
						<div class="logo">
							<a href="/fm0154/index.html"> <img src="<c:url value="/assets/images/logo.png" />"
								alt="img">
							</a>
						</div>
					</div>
								...
								<div class="form-content">
									...
									<div class="inner">
										  <input id="message" type="search" class="input" name="search"
											value="${ keyword }" placeholder="輸入搜尋">
									</div>
...
<!--                                  =================================!!!!! -->
								<c:choose>
									<c:when test="${ not userStatus }">
										<a href="<c:url value="/login" />" data-cleric="dropdown"> <span
											class="flaticon-user"></span>
										</a>
									</c:when>
									<c:otherwise>
					...
					<div class="header-nav">
						<div class="container-wapper">
							<ul class="clone-mobile-menu nav main-menu " id="menu-main-menu">
								...
								<li class="menu-item"><a href="news.html"
									.html" class="menu-item-title" title="News">最新消息與公告</a></li>
								<li class="menu-item"><a href="about.html"
									class="menu-item-title" title="About">關於我們</a></li>
							</ul>
						</div>
					</div>
				</div>
