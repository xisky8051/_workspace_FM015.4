		...
		<div class="container">
				...
				<div class="col-lg-12">
					<div class="breadcrumb-trail breadcrumbs">
						<ul class="trail-items breadcrumb">
							...
							<li class="trail-item trail-end active">最新消息與公告</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="row">
				<div
					...
					<div class="site-main">
						<h3 class="custom_blog_title">最新消息與公告</h3>
						<div class="blog-list list-style">
							<c:forEach items="${ news }" var="news" varStatus="status">
								<div class="blog-item">
									<div class="post-format">
										<a href="#"> <img src="<c:url value="/assets/images/${ news.imgUrl }" />"
											alt="img">
										</a>
									</div>
									<div class="post-info">
										<div class="category-blog">
											<a href="<c:url value="/theNews?id=${ news.id }" />">${ news.subtitle }</a>
										</div>
										<h3 class="post-title">
											<a href="<c:url value="/theNews?id=${ news.id }" />">${ news.title }<span>[...]</span></a>
										</h3>
										<div class="main-info-post">
											<p class="des">
												${fn:substring(news.content, 0, 50)}[...]</p>
										</div>
				...
				<div
					...
					<div class="wrapper-sidebar">
						...
						<div class="widget widget-categories">
							...
							<ul class="list-categories">
								<li><input type="checkbox" id="cb1"> <label
									for="cb1" class="label-text"> 環保新聞 </label></li>
								<li><input type="checkbox" id="cb2"> <label
									for="cb2" class="label-text"> 環保資訊 </label></li>
								<li><input type="checkbox" id="cb3"> <label
									for="cb3" class="label-text"> 網站公告 </label></li>
							</ul>
						</div>
							...
							<ul class="posts">
								<li class="widget-post-item">
									...
									<div class="post-content">
										...
										<h5 class="post-title">
											<a href="#">紙餐具應回收 回收處理量足夠 <span>[...]</span></a>
										</h5>
									</div>
								</li>
								<li class="widget-post-item">
									...
									<div class="post-content">
										...
										<h5 class="post-title">
											<a href="#">訂定固定污染源有害空氣污染物專法 <span>[...]</span></a>
										</h5>
									</div>
								</li>
								<li class="widget-post-item">
									...
									<div class="post-content">
										...
										<h5 class="post-title">
											<a href="#">地下水污染場址改善有成 <span>[...]</span></a>
										</h5>
									</div>
								</li>
						...
						<div class="widget widget-tags">
							<h3 class="widgettitle">熱門標籤</h3>
							<ul class="tagcloud">
								<li class="tag-cloud-link"><a href="#">環保</a></li>
								<li class="tag-cloud-link"><a href="#">污染</a></li>
								<li class="tag-cloud-link"><a href="#">空污</a></li>
								<li class="tag-cloud-link active"><a href="#">地下水</a></li>
								<li class="tag-cloud-link"><a href="#">PM2.5</a></li>
								<li class="tag-cloud-link"><a href="#">回收</a></li>
								<li class="tag-cloud-link"><a href="#">循環</a></li>
							</ul>
						</div>
						<div class="widget newsletter-widget">
							<div class="newsletter-form-wrap ">
								<h3 class="title">訂閱我們的電子報</h3>
								<div class="subtitle">等待下一個人，接手我的寶物</div>
