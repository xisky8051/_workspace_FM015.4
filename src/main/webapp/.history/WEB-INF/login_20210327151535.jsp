									...
									<div class="login-item">
										...
										<form class="login" action="" method="post">
											...
											<p class="form-row form-row-wide">
												...
												<span id="user2" class="fastlogin" onclick="user_click(1);">鮭魚</span>
												<span id="user3" class="fastlogin" onclick="user_click(1);">海綿寶寶</span>
												<span id="user4" class="fastlogin" onclick="user_click(1);">管理員</span>
