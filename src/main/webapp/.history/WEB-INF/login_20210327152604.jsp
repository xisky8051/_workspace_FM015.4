...
<body class="inblog-page">
									...
									<div class="login-item">
										...
										<form class="login" action="" method="post">
											...
											<p class="form-row form-row-wide">
												...
												<span id="user1" class="fastlogin" onclick="user_click(1);">Wendy</span>
												<span id="user2" class="fastlogin" onclick="user_click(2);">鮭魚</span>
												<span id="user3" class="fastlogin" onclick="user_click(3);">海綿寶寶</span>
												<span id="user4" class="fastlogin" onclick="user_click(4);">管理員</span>
	...
	<script>
		function user_click(user) {
				...
				var password = document.getElementById(`userInputPassword`);
				switch(user){
					case 1:
						document.getElementById(`userInputEmail`).value = `wendy.yang@gmail.com`;
						password.textContent = "Do!ng123";
						console.log(1);
						break;
					case 2:
						email.value = "sonia.chang@gmail.com";
						password.value = "Do!ng123";
						console.log(2);
						break;
					case 3:
						email.value = "ann.chen@gmail.com";
						password.value = "Do!ng123";
						console.log(3);
						break;
					case 4:
						email.value = "rock.lin@gmail.com";
						password.value = "Do!ng123";
						console.log(4);
						break;
				}
